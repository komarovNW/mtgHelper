...
class _$SearchSuccessImpl implements SearchSuccess {
  const _$SearchSuccessImpl({required final List<SearchCardModel> allCards})
      : _allCards = allCards;
  ...
  @override
  String toString() {
    return 'SearchState.success(allCards: $allCards)';
  }
...
abstract class SearchSuccess implements SearchState {
  const factory SearchSuccess({required final List<SearchCardModel> allCards}) =
      _$SearchSuccessImpl;
